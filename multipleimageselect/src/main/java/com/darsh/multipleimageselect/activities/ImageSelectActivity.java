...
public class ImageSelectActivity extends HelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("ImageSelectActivity","ImageSelectActivity");
...
Log.e("我要的数据",types+"");
            ...
            if (types!=null){
                if (types.equals("3")){
                    actionBar.setTitle("單擊選擇");
                }else if (types.equals("4")){
                    actionBar.setTitle("Clic para seleccionar");
                }
            }
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               // getString(R.string.selected)
                if (types!=null){
                    if (types.equals("3")){
                        actionMode.setTitle(countSelected + " " +"已選");
                    }else if (types.equals("4")){
                        actionMode.setTitle(countSelected + " " +"seleccionado");
                    }
                }
    ...
    private ActionMode.Callback callback = new ActionMode.Callback() {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            ...
            item = menu.findItem(R.id.menu_item_add_image);
    ...
    private void toggleSelection(int position) {
        if (!images.get(position).isSelected && countSelected >= Constants.limit) {
            Toast.makeText(
                    ...
                    String.format("Puede elegir hasta %d PC", Constants.limit),
                    Toast.LENGTH_SHORT)
                    .show();
            return;
        }
