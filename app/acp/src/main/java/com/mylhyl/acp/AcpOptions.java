...
public final class AcpOptions {
    ...
    private AcpOptions(Builder builder, int language) {
        if (language==1){
            mRationalMessage = "This feature requires your authorization,otherwise it will not work properly.";
            mDeniedMessage = "You refuse to apply for permission, this feature will not work properly, you can go to the settings page to re-authorize";
            mDeniedCloseBtn = "shut down";
            mDeniedSettingBtn = "Setting permissions";
            mRationalBtn = "I know";
    ...
    public static class Builder {
        private static final String DEF_RATIONAL_MESSAGE = "此功能需要您授權，否則將不能正常使用";
        private static final String DEF_DENIED_MESSAGE = "您拒絕權限申請，此功能將不能正常使用，您可以去設置頁面重新授權";
        private static final String DEF_DENIED_CLOSE_BTN_TEXT = "關閉";
        private static final String DEF_DENIED_SETTINGS_BTN_TEXT = "設置權限";
        ...
        public AcpOptions build(int language) {

            if (this.mPermissions == null || this.mPermissions.length == 0) {
                throw new IllegalArgumentException("mPermissions no found...");
            }
            return new AcpOptions(this,language);
        }
    }
}
