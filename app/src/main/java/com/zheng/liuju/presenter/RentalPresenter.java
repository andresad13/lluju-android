...
public class RentalPresenter  extends BasePresenter<IRental> {
    private final RetrofitUtils retrofitUtils;

    public RentalPresenter(){
    ...
    public   void  initOrder(String myLat,String myLng,String token,int type,int page,String time){
        getView().showLoading();
        ...
        Observable<OrderListBean> data = retrofitUtils.getservice().orderlist(token,body);
//改变线程 Rxjava异步
