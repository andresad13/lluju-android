...
import com.zheng.liuju.utils.ExpCalendarUtil;
...
public class WeekColumnView extends LinearLayout {
    ...
    private int startendTextColor = Color.rgb(0, 0, 0);
    private int midTextColor = Color.BLACK;
