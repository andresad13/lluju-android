...
import com.zheng.liuju.presenter.RegisteredPresenter;
...
public class RegisteredFragment extends Fragment implements View.OnFocusChangeListener, View.OnTouchListener, IRegisteredView {
    @BindView(R.id.point)
    TextView point;
    @BindView(R.id.sv)
    ScrollView sv;
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(@NonNull Message msg) {
            if (msg.what == 1) {
                ...
                eventMeager.setSwitchPages(1);//1   手机登录  2 邮箱登录  3 手机注册   4 邮箱注册
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        views = inflater.inflate(R.layout.fragment_registered, container, false);
    ...
    @OnClick({R.id.obtainCode, R.id.cv, R.id.quhaos, R.id.mingwens,R.id.mailboxs})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.obtainCode:
                presenter.isCode(getPhone(), getActivity(), getFomart());
                break;
            case R.id.cv:
                /*  */
                presenter.isRegistered(getPhone(), getCode(), getPassword(), getMailbox(), getSharecode(), getActivity(), getFomart());
                break;
            case R.id.quhaos:
